...
exports.ProcessorTestUtils = void 0;
...
class ProcessorTestUtils {
     ...
     */
    static createTestContext(content, position = 0) {
        const buffer = new CircularStreamBuffer_1.TextCircularBuffer(64, 128);
     ...
     */
    static testAdvanceContract(processor, content) {
     ...
     */
    static testBoundaryConditions(processor) {
        const conditions = [
            { name: 'empty', content: '' },
     ...
     */
    static testPerformance(processor, content, iterations = 1000) {
...
exports.ProcessorTestUtils = ProcessorTestUtils;
describe('Processor Pattern Tests', () => {
    describe('Generic Processor Contracts', () => {
        ...
        test('should maintain reasonable performance', () => {
            const perf = ProcessorTestUtils.testPerformance(processor, test_data_1.TestMarkdown.complex, 100);
    ...
    describe('Processor State Management', () => {
        test('should maintain consistent state across calls', () => {
            const processor = new MarkdownProcessor_1.MarkdownProcessor();
    ...
    describe('Lookahead/Lookbehind Usage', () => {
        test('should handle limited lookahead gracefully', () => {
            ...
            const buffer = new CircularStreamBuffer_1.TextCircularBuffer(10, 5); // Only 5 chars lookahead
